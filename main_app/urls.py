...
urlpatterns = [
    ...
    path("send/student/notification/", hod_views.send_student_notification,
         name='send_student_notification'),
    path("send/staff/notification/", hod_views.send_staff_notification,
         name='send_staff_notification'),
    path("add_session/", hod_views.add_session, name='add_session'),
    path("admin/notify/student", hod_views.admin_notify_student,
         name='admin_notify_student'),
    path("admin/notify/staff", hod_views.admin_notify_staff,
         name='admin_notify_staff'),
    path("admin/view/profile", hod_views.admin_view_profile,
